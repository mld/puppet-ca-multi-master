...
nodes = [
  {:hostname => 'puppetca', :ip => '192.168.50.10',  :box => 'ubuntu/trusty64', :cm => 'shell' },
  {:hostname => 'puppet1',  :ip => '192.168.50.11',  :box => 'ubuntu/trusty64', :cm => 'shell', :ram => 512 },
  {:hostname => 'puppet2',  :ip => '192.168.50.12',  :box => 'ubuntu/trusty64', :cm => 'shell', :ram => 512 },
